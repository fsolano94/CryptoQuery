...
module SwaggerClient
  ...
  class UserPostDto
    attr_accessor :article_query_profile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'articleQueryProfile')
        self.article_query_profile = attributes[:'articleQueryProfile']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          article_query_profile == o.article_query_profile &&
    ...
    def hash
      [article_query_profile, created_at, updated_at, email, user_name, hashed_password, salt].hash
    end
